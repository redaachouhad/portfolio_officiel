    ...
    <div className="w-full flex justify-end sm:justify-start">
      <div className="w-[100%] sm:w-[50%] h-full flex flex-row-reverse sm:flex-row ">
        <div
          ...
          style={{ boxShadow: "0px 0px 10px rgba(0,0,255,0.8)" }}
        >
        ...
        <div className="flex w-12 relative flex-row-reverse sm:flex-row">
          ...
          <div
            className="w-14 h-14 border-[4px] border-blue-800 rounded-full absolute top-0 left-0 sm:left-auto right-auto sm:right-0 -translate-x-1/2 sm:translate-x-1/2 translate-y-1/2"
            style={{
