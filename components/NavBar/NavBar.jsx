...
function NavBar() {
  ...
  return (
    <div className="fixed left-0 top-0 w-full text-white bg-[rgb(61,44,156)] px-4 sm:px-6 md:px-10 py-2 flex justify-between items-center z-50">
      ...
      <div
        className={`absolute lg:static top-full lg:top-auto left-0 lg:left-auto w-full lg:w-fit overflow-hidden transition-height duration-100 ease ${heightMenu} lg:h-fit`}
      >
