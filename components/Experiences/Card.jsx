      ...
      <div className="w-[100%] h-full flex flex-row-reverse">
        ...
        <div className="flex w-12 relative flex-row-reverse">
          <motion.div
            ...
            viewport={{ once: true }}
            className="w-0 h-0 border-[0.45rem] border-transparent border-r-red-500 translate-y-12"
          ></motion.div>
          <motion.div
            initial={{
              scale: 0,
          ...
          <motion.span
            ...
            viewport={{ once: true }}
            className="w-24 h-14 absolute translate-y-1/2 right-full -translate-x-12  hidden text-blue-300  font-semibold"
          >
            {item?.date}
          </motion.span>
        </div>
